        ...
        <div className="flex flex-row gap-8 pt-6">
          ...
          <div className="text_part ">
           ...
           <div className="flex h-auto text-[#807D7A] pt-10">
            <p className="flex  flex-wrap gap-8  font-thin text-2xl justify-start w-[600px] items-start" >( ABOUT ME ) <span className="flex flex-wrap text-2xl">Creating great websites and giving user a better experience is my primary focus. I ensure each project leaves user a good-sensation through </span></p>
