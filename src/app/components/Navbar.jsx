...
const Navbar = () => {
  ...
  return (
    <nav className=" mx-auto flex justify-center bg-[#E6E6E1]   top-0 left-0 right-0 z-8">
      <div className="flex container lg:py-3 flex-wrap justify-around align-middle items-center   space-x-10 mx-auto px-4 py-2 ">
        ...
        <div className="mobile-menu block md:hidden font-bold text-[#6B645C]">
          {!navbarOpen ? (
            <button
              onClick={() => setNavbarOpen(true)}
              className="flex items-center px-3 py-2 border rounded font-bold text-[#6B645C]  hover:text-[#3F3C3B] hover:border-white"
            >
        ...
        <div className="menu hidden md:block md:w-auto" id="navbar">
          <ul className="flex p-4 md:p-0 md:flex-row font-regular md:space-x-8 mt-0">
