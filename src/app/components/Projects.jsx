        ...
        <div className="space-y-80 ">
          ...
          <div className="flex flex-row">
            <div className="p-4 flex w-1/2 justify-center">
              <h2 className="text-[300px] text-[#A19D99] leading-none text-center">
                <span>01.</span>
              </h2>
            </div>
              ...
              <div className="relative flex justify-center items-center w-full h-full">
                ...
                >
                  ...
                  <video
                    ...
                    loop
                    muted
                    className="v_1 items-center  absolute pb-32 h- w-[650px] inset-0 m-auto"
                  ...
                  <div className="flex flex-row  pt-2  ">
                    ...
                    <a
                      href="https://github.com/DevilAr69/Pinterest-clone"
                      className="pt-4 ml-auto space-x-10"
                    >
                      <svg
              ...
              <div className="relative flex justify-center items-center w-full h-full">
                <a href="https://qdra-main.vercel.app/" className="relative">
                  ...
                  <div className="flex flex-row  pt-2  ">
                    ...
                    <a
                      href="https://github.com/DevilAr69?tab=repositories"
                      className="flex flex-end ml-auto   pt-4"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
          ...
          <div className="flex flex-row mb-4 pb-32">
            ...
            <div className="flex w-auto h-[580px]  relative mr-20">
              <div className="relative flex justify-center items-center w-full h-full">
                <a
                  href="https://github.com/DevilAr69/express-system-app"
                  className="relative"
                >
                  <img
                    className="w-[700px] h-[700px] rounded-lg"
                  ...
                  <div className="flex flex-row  pt-2  ">
                    ...
                    <a
                      href=""
                      className="pt-4 flex  ml-auto space-x-10 items-start"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
